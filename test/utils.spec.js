...
describe('utils.js', () => {
    ...
    describe('formatNumber(number, digits)', () => {
        it('will split integer part with comma, default in 3 digits.', () => {
            expect(utils.formatNumber(10000)).toBe('10,000');
            expect(utils.formatNumber(10000.123)).toBe('10,000.123');
            expect(utils.formatNumber(10000, 4)).toBe('1,0000');
            expect(utils.formatNumber(10000.123, 4)).toBe('1,0000.123');
        });
    });
